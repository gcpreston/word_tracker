defmodule WordTrackerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WordTrackerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WordTrackerWeb.Gettext, "errors", msg, opts)
    end
  end
